...
person.name = 'rahul';  // Error: Cannot assign to read only property 'name'
person.email = 'rahul@example.com'; // Error: Cannot assign to read only property 'email'
