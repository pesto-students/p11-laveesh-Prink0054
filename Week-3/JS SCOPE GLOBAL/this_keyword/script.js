...
const person1 = new Person("Rohan", 25, "male", "American");
const person2 = new Person("Rahul", 30, "female", "Canadian");
const person3 = new Person("Rajev", 20, "male", "Australian");
...
const student1 = new Student("Prink", 18, "male", "Indian", "Computer Science");
